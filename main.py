...
printer = pygame.image.load(os.path.join("./assets/images/Printer.png")).convert()
moneyicon = pygame.image.load(os.path.join("./assets/images/Money-icon.png")).convert()
mouse1 = pygame.image.load(os.path.join("./assets/images/mouse1.png")).convert()
mouse2 = pygame.image.load(os.path.join("./assets/images/mouse2.png")).convert()
mouse3 = pygame.image.load(os.path.join("./assets/images/mouse3.png")).convert()
mouse4 = pygame.image.load(os.path.join("./assets/images/mouse4.png")).convert()
mouse5 = pygame.image.load(os.path.join("./assets/images/mouse5.png")).convert()
Pause = pygame.image.load(os.path.join("./assets/images/Pause.png")).convert()
picupgrade1 = pygame.image.load(os.path.join("./assets/images/upgrade1.png")).convert()
picupgrade2 = pygame.image.load(os.path.join("./assets/images/upgrade2.png")).convert()
picupgrade3 = pygame.image.load(os.path.join("./assets/images/upgrade3.png")).convert()
picupgrade4 = pygame.image.load(os.path.join("./assets/images/upgrade4.png")).convert()
picupgrade5 = pygame.image.load(os.path.join("./assets/images/upgrade5.png")).convert()
picupgrade6 = pygame.image.load(os.path.join("./assets/images/upgrade6.png")).convert()
exitsign = pygame.image.load(os.path.join("./assets/images/exit.png")).convert()
shopsign = pygame.image.load(os.path.join("./assets/images/shop.png")).convert()
...
frameback = pygame.image.load(os.path.join("./assets/images/frameback.png")).convert()
...
def shop():
 ...
 ####################################### buttons with pixtures for shop ui
        ...
        shop_clicker_text = Text_create("Clicker Upgrades", "#8fffa5", black, 20, 170, 52)
        shop_clicker_text = Text_create("Printer Upgrades", "#8fffa5", black, 20, 990, 45)
