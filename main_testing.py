...
def main_loop():
    ...
    while active:
        ...
        Upgrade1, starty_1, sizex_1, sizey_1 = Button_make.button(575,25,200,65,0, picupgrade1)
        Upgrade2, starty_2, sizex_2, sizey_2 = Button_make.button(575,112.5,200,65,0, picupgrade2)
        Upgrade3, starty_3, sizex_3, sizey_3 = Button_make.button(575,200,200,65,0, picupgrade3)
        Upgrade4, starty_4, sizex_4, sizey_4 = Button_make.button(575,287.5,200,65,0, picupgrade4)
        Upgrade5, starty_5, sizex_5, sizey_5 = Button_make.button(575,375,200,65,0, picupgrade5)
        Upgrade6, starty_6, sizex_6, sizey_6 = Button_make.button(575,462.5,200,65,0, picupgrade6)
        counterup1 = Text_create("£ "+str(f"{upgradeprice1:.2f}"), white, black, 20, 876, 75)
        counterup2 = Text_create("£ "+str(f"{upgradeprice2:.2f}"), white, black, 20, 876, 162)
        counterup3 = Text_create("£ "+str(f"{upgradeprice3:.2f}"), white, black, 20, 876, 250)
        counterup4 = Text_create("£ "+str(f"{upgradeprice4:.2f}"), white, black, 20, 876, 339)
        counterup5 = Text_create("£ "+str(f"{upgradeprice5:.2f}"), white, black, 20, 876, 425)
        counterup6 = Text_create("£ "+str(f"{upgradeprice6:.2f}"), white, black, 20, 876, 511)
