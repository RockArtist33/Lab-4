...
def main_loop():
    ...
    while active:
        ...
        startx, starty, sizex, sizey = Button_make.button(dark_grey,50,50,500,500,160)
        printer = pygame.transform.scale(printer,(sizex, sizey))
        screen.blit(printer,(startx, starty),)
        Upgrade1, starty_1, sizex_1, sizey_1 = Button_make.button(dark_grey,975,25,200,65,128)
        Upgrade2, starty_2, sizex_2, sizey_2 = Button_make.button(dark_grey,975,112.5,200,65,128)
        Upgrade3, starty_3, sizex_3, sizey_3 = Button_make.button(dark_grey,975,200,200,65,128)
        Upgrade4, starty_4, sizex_4, sizey_4 = Button_make.button(dark_grey,975,287.5,200,65,128)
        Upgrade5, starty_5, sizex_5, sizey_5 = Button_make.button(dark_grey,975,375,200,65,128)
        Upgrade6, starty_6, sizex_6, sizey_6 = Button_make.button(dark_grey,975,462.5,200,65,128)
        counterup1 = Text_create("£ "+str(f"{upgradeprice1:.2f}"), white, black, 20, 1076, 75)
        counterup2 = Text_create("£ "+str(f"{upgradeprice2:.2f}"), white, black, 20, 1076, 162)
        counterup3 = Text_create("£ "+str(f"{upgradeprice3:.2f}"), white, black, 20, 1076, 250)
        counterup4 = Text_create("£ "+str(f"{upgradeprice4:.2f}"), white, black, 20, 1076, 339)
        counterup5 = Text_create("£ "+str(f"{upgradeprice5:.2f}"), white, black, 20, 1076, 425)
        counterup6 = Text_create("£ "+str(f"{upgradeprice6:.2f}"), white, black, 20, 1076, 511)
